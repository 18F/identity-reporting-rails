...
module Reporting
  ...
  # Usage:
  #   reporter = PartnerReportDefaultV2.new(
  ...
  class PartnerReportDefaultV2
    ...
    INTEGER_DATA_FIELDS = %w[
      ...
      count_blocked_document_upload_ux
      count_selfie_ux
